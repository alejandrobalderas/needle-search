  ...
  return (
    <ul className={cn("grid gap-0.5", className)}>
      <li>
        ...
        <AISearchModal>
          <div className="flex h-8 w-full min-w-8 flex-1 cursor-pointer items-center gap-2 overflow-hidden rounded-md px-1.5 text-sm font-medium outline-none ring-ring transition-all hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 data-[state=open]:bg-accent data-[state=open]:text-accent-foreground">
            ...
            <div className="relative flex items-center">
              <Link
                ...
                className={cn(
                  ...
                  item.disabled &&
                    "text-muted-foreground hover:cursor-default hover:bg-transparent hover:text-muted-foreground focus-visible:ring-0",
                )}
              >
              ...
              {!item.disabled && item.items && item.items.length > 0 && (
